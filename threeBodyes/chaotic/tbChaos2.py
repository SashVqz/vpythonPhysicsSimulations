...
p = sphere(pos=vector(-1, 0, 0), radius=0.09, color=color.red, mass=mass, make_trail=True, trail_type='points', interval=25, retain=15)
planets.append(p)
p = sphere(pos=vector(0, 0, 0), radius=0.09, color=color.blue, mass=mass, make_trail=True, trail_type='points', interval=25, retain=15)
planets.append(p)
p = sphere(pos=vector(-2, 1, 0), radius=0.08, color=color.cyan, mass=0.2, make_trail=True, trail_type='points', interval=25, retain=15)
planets.append(p)
...
planets[0].velocity = vector(v / 5, v / 2, 0)
planets[1].velocity = vector(v / 5, -v / 2, 0)
planets[2].velocity = vector(v / 5, v / 5, 0)
